...
public class DonorInitializer {
    ...
    static Donor donor4 = new Donor("AA2400004", Donor.Type.ORGANISATION, Donor.Category.PRIVATE, "Tan Jian Hui", 67, LocalDate.of(1957, 06, 20), Donor.Gender.OTHER, "0189997777");
